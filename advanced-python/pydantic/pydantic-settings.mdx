...
To reinforce what you've learned in this chapter (Type Hints, Dataclasses, BaseModel schemas, field constraints, custom validators, nested models, and environment settings), practice with these consolidated interactive notebooks:
...
<CardGroup cols={2}>
  <Card
    ...
    icon="laptop-code"
  >
    Practice writing type hints, defining dataclasses, building BaseModel schemas, assigning Field constraints, writing custom field validators, nesting models, mapping union/optional fields, and exporting configurations.
  ...
  <Card
    ...
    icon="pen-to-square"
  >
    Test your knowledge with hands-on exercises on function annotations, custom book dataclasses, employee validation, custom validation rules, nested model structures, and configuration setting setups.
