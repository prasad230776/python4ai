---
title: "Type Hints"
description: "Learn how Type Hints form the foundation of Python data validation and static checking."
icon: "keyboard"
---
...
<CardGroup cols={2}>
  <Card
    ...
    icon="laptop-code"
  >
    Practice declaring basic variable type hints, annotating function parameters/returns, and working with modern union and optional types.
  ...
  <Card
    ...
    icon="pen-to-square"
  >
    Test your knowledge with hands-on exercises annotating function signatures and handling optional/union input parameters.
...
<Card
  ...
  icon="arrow-right"
  href="/pydantic/your-first-model"
>
