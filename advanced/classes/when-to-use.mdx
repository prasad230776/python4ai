...
Now that you have completed all classes concepts, test and reinforce your understanding with hands-on practice problems.

<Card
  title="Practice & Exercises"
  icon="pen-to-square"
  href="/advanced/classes/practice-exercises"
>
  Practice writing and designing classes
</Card>