...
Now that you understand classes, let's learn how to handle errors and exceptions in your code.

<Card
  title="Error Handling"
  icon="shield-check"
  href="/advanced/error-handling/index"
>
  Catch and manage errors before they crash your program
</Card>