...
<CardGroup cols={2}>
  ...
  >
    ...
    [💻 VS Code](vscode://file/Users/sivaprasad/Downloads/python%20material/python4ai/notebooks/pandas_student_exercise.ipynb) | [🚀 Colab](https://colab.research.google.com/github/prasad230776/python4ai/blob/master/notebooks/pandas_student_exercise.ipynb) | <a href="/notebooks/pandas_student_exercise.ipynb" download>📥 Download</a>
  </Card>
  <Card
