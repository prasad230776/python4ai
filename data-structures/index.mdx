...
<CardGroup cols={2}>
  ...
  <Card title="Queues" icon="lines-leaning" href="/data-structures/queues">
    First-In, First-Out (FIFO) collections
  </Card>
  <Card title="Data Structures Implementation" icon="folder-tree" href="/data-structures/summary">
    CRUD operations on core structures
  </Card>
</CardGroup>
