...
An HTTP request typically contains the following components:

- **URL** – The address of the requested resource.
- **HTTP Method** – The action to perform (GET, POST, PUT, DELETE, etc.).
- **Headers** – Additional information about the request.
- **Path Parameters** – Values embedded in the URL.
- **Query Parameters** – Optional values appended to the URL.
- **Cookies** – Client-specific information.
- **Request Body** – Data sent to the server (usually JSON).

### General Structure

```
HTTP_METHOD /resource HTTP/1.1
Host: example.com
Headers
