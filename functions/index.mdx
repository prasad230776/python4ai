...
<CardGroup cols={2}>
  ...
  <Card title="Flexible argument handling" icon="sliders" href="/functions/advanced-parameters">
    Master *args, **kwargs, positional & keyword-only arguments
  </Card>
  <Card title="Scopes & Nested functions" icon="brackets-curly" href="/functions/scopes-nested-functions">
    Understand variable scope, the LEGB rule, global & nonlocal
  </Card>
  <Card title="Recursion" icon="arrows-rotate" href="/functions/recursion">
    Learn how functions call themselves to solve problems
  </Card>
</CardGroup>
