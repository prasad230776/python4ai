...
To reinforce what you've learned in the Getting Started section, practice with these interactive notebooks:
...
<CardGroup cols={2}>
  <Card
    ...
    icon="laptop-code"
  >
    Practice all the setup, package verification, and interactive commands discussed in this section.

    [💻 VS Code](vscode://file/Users/sivaprasad/Downloads/python%20material/python4ai/public/notebooks/basics_exercises/Getting_Started_Practice.ipynb) | [🚀 Colab](https://colab.research.google.com/github/prasad230776/python4ai/blob/master/public/notebooks/basics_exercises/Getting_Started_Practice.ipynb) | <a href="/public/notebooks/basics_exercises/Getting_Started_Practice.ipynb" download>📥 Download</a>
  </Card>
  <Card
    title="Practice Exercises"
    icon="pen-to-square"
  >
    Test your environment setup and basic debugging skills with interactive exercises.

    [💻 VS Code](vscode://file/Users/sivaprasad/Downloads/python%20material/python4ai/public/notebooks/basics_exercises/Getting_Started_Exercises.ipynb) | [🚀 Colab](https://colab.research.google.com/github/prasad230776/python4ai/blob/master/public/notebooks/basics_exercises/Getting_Started_Exercises.ipynb) | <a href="/public/notebooks/basics_exercises/Getting_Started_Exercises.ipynb" download>📥 Download</a>
  </Card>
</CardGroup>
