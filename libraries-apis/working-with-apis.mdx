...
<CardGroup cols={2}>
  <Card
    ...
    icon="laptop-code"
  >
    Practice submitting coordinate parameters to weather APIs using requests, extracting nested dictionary properties, and writing query wrappers to compare temperature statistics.
  ...
  <Card
    ...
    icon="pen-to-square"
  >
    Test your knowledge with hands-on exercises on querying Indian cities, writing get_weather_details for temperature/wind outputs, and adding exception handling to API calls.
...
<Card
  ...
  icon="arrow-right"
  href="/libraries-apis/working-with-env"
>
