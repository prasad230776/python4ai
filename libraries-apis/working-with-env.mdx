...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="pen-to-square"
  >
    Test your knowledge with hands-on exercises on building automatic .env.example configuration templates, writing APP_ENV reload logic, and building multi-key configuration validators.
