---
title: "Introduction"
description: "Pydantic brings runtime data validation to Python using type hints."
icon: "info"
---
...
<CardGroup cols={2}>
  <Card
    ...
    icon="laptop-code"
  >
    Practice the basics of dynamic typing limitations, handling runtime errors, and using Pydantic models for basic validation and error handling.
  ...
  <Card
    ...
    icon="pen-to-square"
  >
    Test your knowledge with exercises defining simple Pydantic models and handling ValidationErrors.
