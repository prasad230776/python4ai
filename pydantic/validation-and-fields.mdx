...
description: "Control what data is acceptable using Field constraints and validators."
icon: "shield-check"
---
...
<CardGroup cols={2}>
  <Card
    ...
    icon="laptop-code"
  >
    Practice setting up numeric constraints, string constraints, descriptions, defaults using Field(), and implementing custom validators with @field_validator.
