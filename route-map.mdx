...
* **[Data Validation & Type Hints](/advanced-python/data-validation)**
  * Complex type annotations & Python Dataclasses
* **[Pydantic](/advanced-python/pydantic)**
  * BaseModel schemas, constraints, custom field validators, and JSON serialization
...
## [Module 5: Data Analysis](/data-analysis/numpy)
